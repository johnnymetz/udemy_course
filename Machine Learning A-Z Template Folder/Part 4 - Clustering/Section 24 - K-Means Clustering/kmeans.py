...
wcss = []  # within cluster sum of squares: minimize each point's distance from its centroid 
for i in range(1, 11):
...
y_kmeans = kmeans.fit_predict(X)  # for each observation, returns cluster it belongs to
